...
export class FinCustodian extends Web3Auth {
  fincusId: string;
  constructor(options: FinCustodianOption) {
    const clientId =
      "BM0x6zc4KOYpBbZz4MTubBar2bpUYpv_hEq9UYnFDuhhRL_Z1EHrnihHmEZZ1h4wh0Zmg8HlQRh-xER5Ka7M5W4";
